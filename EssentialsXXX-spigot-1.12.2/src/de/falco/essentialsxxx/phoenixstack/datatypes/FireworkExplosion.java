...
import de.falco.essentialsxxx.phoenixstack.enums.Color;
...
/*
 * @Info class for handle FireworkExplosions used in Firework and FireworkEffect datatypes
 */
public class FireworkExplosion {
	...
	private byte flicker = 0;
	private byte trail = 0;
